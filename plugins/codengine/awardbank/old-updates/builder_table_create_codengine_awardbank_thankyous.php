...
class BuilderTableCreateCodengineAwardbankThankyous extends Migration
{
    public function up()
    {
        Schema::create('codengine_awardbank_thankyous', function($table)
        {
            $table->engine = 'InnoDB';
            $table->increments('id');
            ...
            $table->text('thankyou_text')->nullable();
    ...
    {
        Schema::dropIfExists('codengine_awardbank_thankyous');
    }
}