...
class ProgramToolsList extends ComponentBase
{
    ...
    {
        return [
            'name' => 'Program Tools List',
            'description' => 'List Of All Program Tools',
        ];
    }
    ...
    **/
    ...
    {
        $this->html1 = $this->renderPartial('@programtoolslist',
            [
                'posts' => $this->posts,
