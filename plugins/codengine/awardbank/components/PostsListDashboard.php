...
class PostsListDashboard extends ComponentBase
{
    ...
    {
        return [
            'name' => 'Posts Dashboard List',
            'description' => 'Posts List For Dashboard',
        ];
    }
    ...
    **/
    ...
    public function onPostsPaginate()
    {
        ...
        $html = $this->renderPartial('@postslist.htm',
            [
                'user' => $this->user,
                'posts' => $this->posts,
                'manager' => $this->manager,
