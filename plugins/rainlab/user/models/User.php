...
class User extends UserBase
{
    ...
    /**
     * Returns full business name
     * @return mixed|string
     */
    public function getFullBusinessName()
    {
        if ($this->full_name !=  $this->business_name) {
            return trim(implode('<br/>', [$this->full_name, $this->business_name ?? '']));
        } else {
